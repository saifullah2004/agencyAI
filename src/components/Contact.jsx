...
const Contact = () => {
    ...
    formData.append("access_key", "cf82a842-20e4-402d-a4d0-d64b09a135b1");
  ...
  return (
    <div id='contact-us' className='flex flex-col items-center gap-7 px-4 sm:px-12 lg:px-24 xl:px-40 pt-30 text-gray-700 dark:text-white'>
        ...
        <Title title={'React out to us'} desc={'Ready to grow your brand? Lets connect and build something exceptional together.'}/>
