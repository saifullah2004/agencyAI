    ...
    <div className='bg-slate-50 dark:bg-gray-900 pt-10 sm:pt-10 mt-20 sm:mt-40 px-4 sm:px-10 lg:px-24 xl:px-40'>
        ...
        <div className='text-gray-600 dark:text-gray-400'>
            ...
            <div className='flex gap-2 text-sm'>
                <input type="email" placeholder='Enter your email' className='w-full p-3 text-sm outline-none rounded bg-transparent dark:text-gray-200 border border-gray-300 dark:border-gray-500'/>
        ...
        <div className='pb-6 text-sm text-gray-500 flex sm:justify-between justify-center gap-4 flex-wrap'>
            <p>Copyright 2025 @ Saif - All right Reserved.</p>
